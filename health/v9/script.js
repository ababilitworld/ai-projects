...
(() => {
  ...
  document.addEventListener('keydown',e=>{if(e.key!=='Escape')return;if(shell.classList.contains('open'))closeModal();else if(dock.classList.contains('open')){setDock(false);launcher.focus();}});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  launcher.setAttribute('title','Open Action, Navigation, Interaction and Appearance terminal');
});
