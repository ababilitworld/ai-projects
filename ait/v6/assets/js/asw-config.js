(function configureSoftwareStarter(global) {
  ...
  const config = {
    ...
    menu: [
      { id: 'workspace', label: 'Workspace', description: 'Module, Data Center, Backup and Report', icon: 'W', modal: 'workspace' },
      { id: 'settings', label: 'Settings', description: 'Appearance, interaction, navigation, notification and activity', icon: 'S', modal: 'settings' }
    ],
    workspace: {
      items: [
        { id: 'module', label: 'Module', description: 'Book and future software modules', icon: 'M', modal: 'module' },
      ...
      modules: [
        { id: 'book', label: 'Book', description: 'Taxonomy, records, eBook, CSV backup and print', icon: 'BK', modal: 'book-module' }
      ],
      report: [
    ...
    book: {
      items: [
        { id: 'taxonomy', label: 'Taxonomy', description: 'Template, Category, Tag, Author and Genre', icon: 'TX', modal: 'book-taxonomy' },
        { id: 'posttype', label: 'Post Type', description: 'Book record workspaces', icon: 'PT', modal: 'book-posttype' },
        { id: 'data-center', label: 'Data Center', description: 'Book data portability and backup', icon: 'DC', modal: 'book-data-center' },
        { id: 'report', label: 'Report', description: 'Book output workspaces', icon: 'RP', modal: 'book-report' }
      ],
      taxonomy: [
        { id: 'template', label: 'Template', description: 'Reusable Book layout classifications', icon: 'TP', modal: 'book-taxonomy-template' },
        { id: 'category', label: 'Category', description: 'Primary Book classifications', icon: 'CA', modal: 'book-taxonomy-category' },
        { id: 'tag', label: 'Tag', description: 'Flexible Book labels', icon: 'TG', modal: 'book-taxonomy-tag' },
        { id: 'author', label: 'Author', description: 'Author classifications and identities', icon: 'AU', modal: 'book-taxonomy-author' },
        { id: 'genre', label: 'Genre', description: 'Book genre classifications', icon: 'GE', modal: 'book-taxonomy-genre' }
      ],
      postTypes: [
        { id: 'book', label: 'Book', description: 'Book record type', icon: 'BK', modal: 'book-post-type' }
      ],
      bookWorkspaces: [
        { id: 'list', label: 'List', description: 'Create and manage Book records', icon: 'LS', modal: 'book-list' },
        { id: 'ebook', label: 'eBook', description: 'Empty AIT-PHA-style page and component workspace', icon: 'EB', modal: 'book-ebook' }
      ],
      dataCenter: [
        { id: 'backup', label: 'Backup', description: 'CSV export and import for Book data', icon: 'BU', modal: 'book-backup' }
      ],
      report: [
        { id: 'print', label: 'Print', description: 'Color print workspace with A0, A4 and A5', icon: 'PR', modal: 'book-print' }
      ]
    },
    settings: {
      items: [
