  ...
  menu:[
    {id:'workspace',label:'Workspace',icon:'⚡',description:'Data Center and reports',children:[
      ...
      {id:'report',label:'Report',icon:'🖨',description:'Print, poster and image',children:[
        {id:'print',label:'Print',icon:'🖨',description:'Unified normal and book print workspace',action:{type:'workspace',route:'print/index.html',title:'Print Workspace',breadcrumb:['Workspace','Report','Print']}},
        {id:'poster',label:'Poster',icon:'🪧',description:'Unified poster design and output workspace',action:{type:'workspace',route:'poster/index.html',title:'Poster Workspace',breadcrumb:['Workspace','Report','Poster']}},
