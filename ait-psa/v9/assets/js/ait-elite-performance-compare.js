...
(()=>{"use strict";
 ...
 const init=()=>{
  ...
  const compare=document.createElement('button');compare.type='button';compare.className='ait-psa-terminal-command';compare.dataset.aitPsaOpen='aitEliteCompareModal';compare.dataset.monitor='all';compare.innerHTML='<span>⇄</span><b>Compare 2D, 3D, 6D and 9D</b><small>Best-to-worst historical ranking of eight scanners, with evidence and signal details.</small>';menu.appendChild(compare);
